            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">Home</a></li>
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">Products</a></li>
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">About Us</a></li>
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">FAQ</a></li>
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">Shipping Info</a></li>
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">Returns</a></li>
                            <li><a href="#" className="text-textMuted hover:text-textMain text-sm">Track Order</a></li>
                        </ul>
                    </div>
                ...
                <div className="mt-10 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between">
                    <p className="text-sm text-gray-500">
                        &copy; 2024 E-Market. All rights reserved.
                    </p>
