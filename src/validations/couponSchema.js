...
export const couponSchema = yup.object({
  ...
  value: yup
    ...
    .test('percentage-limit', 'Le pourcentage ne peut pas dépasser 100%', function (value) {
  ...
  expirationDate: yup
    ...
    .test('after-start', "La date d'expiration doit être après la date de début", function (value) {
