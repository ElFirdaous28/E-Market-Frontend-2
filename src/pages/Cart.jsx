...
export default function Cart() {
  ...
  const { cart, isLoading, removeItem, updateQuantity, clearCart, summary, isSummaryLoading } =
    useCart({
    ...
    validateCoupon.mutate(
      {
        code: couponCode,
        couponCodes: appliedCoupons.map((c) => c.code),
        purchaseAmount: summary?.total || 0,
      },
      {
        onSuccess: (res) => {
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mb-3">
                          <span className="text-success-light text-sm font-medium">In Stock</span>
                        </div>
                      </div>
                      <button
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div className="flex items-center space-x-3 border border-border rounded-lg">
                        ...
                        <span className="text-textMain font-medium">{item.quantity}</span>
                        <button
                          onClick={() =>
                            updateQuantity.mutate({
                              productId: item.productId._id,
      ...
      <div className="lg:col-span-1">
        {isSummaryLoading ? (
          ...
          <div className="bg-surface rounded-lg border border-border p-6 sticky">
            <h2 className="text-xl font-bold text-textMain-light mb-6">Order Summary</h2>
            ...
            <div className="mb-6">
              ...
              {couponError && <p className="text-sm text-red-700 mt-1">{couponError}</p>}
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-2xl font-bold text-primary">${summary?.finalAmount}</span>
            </div>
