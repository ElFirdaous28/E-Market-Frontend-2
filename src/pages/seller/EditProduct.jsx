    ...
    return (
      <div className="max-w-6xl mx-auto">
        <div className="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-lg">
          ...
          <button onClick={() => navigate('/seller/products')} className="mt-3 text-sm underline">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {existingSecondaryImages.map((url, i) => (
                    <div
                      key={i}
                      className="relative w-24 h-24 border border-border rounded-lg overflow-hidden opacity-60"
                    >
                      <img
                        src={url}
                        alt={`existing ${i + 1}`}
